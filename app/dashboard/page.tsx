  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-xl mx-auto px-4 py-12">
        ...
        {/* Setup Card - Matches dashboard card style */}
        <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-b border-amber-200 px-6 py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-gray-900">Connect Your Socials</p>
                <p className="text-sm text-gray-600">Your AI is ready — just needs access to your DMs</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6">
            ...
            {ghlConnectUrl ? (
              <a
                ...
                className="flex items-center justify-center gap-2 w-full px-5 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all shadow-lg shadow-indigo-500/25 hover:shadow-xl hover:shadow-indigo-500/30"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              ...
              <p className="text-sm text-amber-600 bg-amber-50 px-4 py-3 rounded-xl text-center">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 mt-4">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-gray-900">AI starts responding instantly</p>
