  ...
  return (
    <>
      ...
      <div className="min-h-screen relative overflow-hidden bg-[#0f0f1a]">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-indigo-500/20 rounded-full blur-3xl animate-float2" />
                      ...
                      <div className="mb-6">
                        <div className="flex gap-2 justify-center">
                          {[0, 1, 2, 3, 4, 5].map((i) => (
                            <div
                              key={i}
                              className={`w-12 h-14 flex items-center justify-center rounded-lg border text-2xl font-mono transition-all ${
                                code[i] 
                        ...
                        <div 
                          className="mt-4 text-center text-sm text-gray-400 cursor-pointer hover:text-white transition-colors"
                          onClick={() => document.querySelector('input[type="text"]')?.focus()}
                        >
                          Click here to type code
                        </div>
                      </div>
